  ...
  return (
    <>
      ...
      <SiteMeta
        ...
        title={
          topic.title ? `${topic.title[0].text} | People for Bikes` : meta.title
        }
        imgHeight={
          topic.banner_image
            ? topic.banner_image["1x"].dimensions.height
            : meta.imgHeight
        }
        imgSrc={topic.banner_image ? topic.banner_image["1x"].url : meta.imgSrc}
        imgWidth={
          topic.banner_image
            ? topic.banner_image["1x"].dimensions.width
            : meta.imgWidth
        }
        path={
          topic
            ? `https://www.peopleforbikes.org/topics/${topic._meta.uid}`
            : meta.path
        }
      />
                        ...
                        >
                          ...
                          <ul>
                            {pillar.news_item_1 && (
                              <li>
                                <Link
                                  href={`/news/${pillar.news_item_1._meta.uid}`}
                                  passHref
                                >
                            ...
                            {pillar.news_item_2 && (
                              <li>
                                <Link
                                  href={`/news/${pillar.news_item_2._meta.uid}`}
                                  passHref
                                >
                            ...
                            {pillar.news_item_3 && (
                              <li>
                                <Link
                                  href={`/news/${pillar.news_item_3._meta.uid}`}
                                  passHref
                                >
                      ...
                      <>
                        ...
                        {page[1].map((newsItem) => {
                          ...
                          const newDate = newsItem.data.publication_date
                            ? new Date(
                                ParseDate(newsItem.data.publication_date)
                              )
                            : new Date(
                                ParseDate(newsItem.last_publication_date)
                              );
                          return (
                            <ContentItem
                              ...
                              text={
                                newsItem.data.main_content[0].type ===
                                "paragraph"
