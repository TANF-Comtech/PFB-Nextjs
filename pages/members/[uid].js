    ...
    <>
      ...
      <Wrapper postPath="/members" postTitle="Member Center" isWide="true">
        ...
        { // HEADER - either bold red text + header image OR 
          ...
          member_content.main_text && 
          member_content.secondary_text ? (
          <>
        ...
        { member_content.body &&
          member_content.body.map((slice) => {
            ...
            if (slice.type === "summary_block" ) {
              return (
                <SummaryBlock 
                  bgColor={ member_content._meta.uid === 'owners-manual' ?  '#fff' : themeProps.midnightBlue }
                  buttons={ slice.fields }
                  key={ randomID(10000000) }
                  fontSize="28px"
                  lineHeight="42px"
                  maxWidth="800px"
                  textColor={ member_content._meta.uid === 'owners-manual' ?  themeProps.black : '#fff' }
