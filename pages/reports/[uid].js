  ...
  return (
    <>
      ...
      <SiteMeta
        desc={
          report.main_content
            ? `${report.main_content[0].text.substring(0, 180)} ... `
            : meta.desc
        }
        title={
          report.title
            ? `${report.title[0].text} | People for Bikes`
            : meta.title
        }
        ...
        path={
          report
            ? `https://www.peopleforbikes.org/reports/${report._meta.uid}`
            : meta.path
        }
      />
