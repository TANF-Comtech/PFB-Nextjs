 ...
 *
 * Our main use case is that their rich text field embed functionality is awful
 * So we can augment it creatively...
 * PFB needs to embed a lot of stuff
 * They can just use <pre> tags and we can hijack those and actually render the content
