...
export const linkResolver = (
  ...
  if ( (linkWrapper === true && link.__typename === '_ExternalLink') || 
       (linkWrapper === true && link.__typename === '_FileLink') ||
       (linkWrapper === true && link.__typename === '_ImageLink') ) {
    return `${link.url}`
  } 
