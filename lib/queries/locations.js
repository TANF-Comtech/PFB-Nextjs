...
import { prismicClient, getPrismicData, API_LOCALE } from '~/lib/api';
import { actionitemSliceFields, ridespotSliceFields } from '~/lib/queries/fragments';
    ...
    .get(
      {
        predicates: [
          ...
          prismic.predicate.at('my.news.locations.location', data.locations._meta.id),
        ],
      },
