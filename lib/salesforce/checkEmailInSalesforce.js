...
export const salesforceInstanceURL = process.env.SALESFORCE_INSTANCE_URL
...
const checkEmailInSalesforce = (email) => {
    ...
    return getAccessToken().then(data=>{
        ...
        .then(function(res) {
            ...
            throw new Error('<p>Your email is currently not registered. Please register here: <a href="https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center">https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center</a>. Your employer must be a current PeopleForBikes Corporate Member to gain access to the Member Center.</p>');
        }
        }).then(customerID =>{
            ...
            return affiliationIDs
                ...
                throw new Error('<p>Your email is not affiliated with an organization in our database. Please contact Kerri Salazar at <a href="mailto:Kerri@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Email%20Affiliation%20Error">Kerri@peopleforbikes.org</a></p>');    
            }
            ...
            .then(function(res) {
                ...
                if(authedOrg){
                    ...
                    throw new Error('<p>Your organization\'s membership has expired, please contact Kerri Salazar at <a href="mailto:Kerri@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Organization%20Expiration">Kerri@peopleforbikes.org</a></p>');    
                }
            })
        })  
        }).catch(error => {
