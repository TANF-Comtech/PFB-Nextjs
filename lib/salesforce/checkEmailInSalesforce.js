    ...
    return getAccessToken().then(data=>{
        ...
        .then(function(res) {
            ...
            return affiliationIDs
                ...
                throw new Error("Your email has no affiliations in our database. Please contact Kerri Salazar at Kerri@peopleforbikes.org");    
            }
            ...
            .then(function(res) {
                ...
                if(authedOrg){
                    ...
                    throw new Error("Your affiliation membership has expired, please contact Kerri Salazar at Kerri@peopleforbikes.org");    
                }
            })
        })  
        }).catch(error => {
