...
const checkEmailInSalesforce = (email) => {
    ...
    return getAccessToken().then(data=>{
        ...
        .then(function(res) {
            ...
            throw new Error('Your email is currently not registered. Please register here: <a href="https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center">https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center</a>. Your employer must be a current PeopleForBikes Corporate Member to gain access to the Member Center.');
        }
        }).then(customerID =>{
            ...
            return affiliationIDs
                ...
                throw new Error("Your email is not affiliated with an organization in our database. Please contact Kerri Salazar at Kerri@peopleforbikes.org");    
            }
            ...
            .then(function(res) {
                ...
                if(authedOrg){
                    ...
                    throw new Error("Your organization's membership has expired, please contact Kerri Salazar at Kerri@peopleforbikes.org");    
                }
            })
        })  
        }).catch(error => {
