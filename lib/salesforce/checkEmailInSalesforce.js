    ...
    return getAccessToken().then(data=>{
        ...
        .then(function(res) {
            ...
            return affiliationIDs
                ...
                throw new Error("<p>Your email is not affiliated with an organization in our database. Please contact Kerri Salazar at Kerri@peopleforbikes.org</p>");    
            }
            ...
            .then(function(res) {
                ...
                if(authedOrg){
                    ...
                    throw new Error("<p>Your organization's membership has expired, please contact Kerri Salazar at Kerri@peopleforbikes.org</p>");    
                }
            })
        })  
        }).catch(error => {
