        ...
        return sfConnection
          ...
          .then(function (res) {
            if (res.records.length > 0) {
              ...
              throw new Error(
                '<p>Your email is not affiliated with an organization in our database. Please contact Kerri Salazar at <a href="mailto:Kerri@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Email%20Affiliation%20Error">Kerri@peopleforbikes.org</a></p>',
              );
            }
          })
          .then((affiliationIDs) => {
            ...
            return sfConnection
              ...
              .then(function (res) {
                ...
                if (authedOrg) {
                  ...
                  throw new Error(
                    '<p>Your organization\'s membership has expired, please contact Kerri Salazar at <a href="mailto:Kerri@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Organization%20Expiration">Kerri@peopleforbikes.org</a></p>',
                  );
                }
              });
          });
