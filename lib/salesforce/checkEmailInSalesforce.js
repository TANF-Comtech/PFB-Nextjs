...
const checkEmailInSalesforce = (email) => {
    ...
    return getAccessToken().then(data=>{
        ...
        .then(function(res) {
            ...
            throw new Error("Your email is currently not registered. Please register here: https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center. Your employer must be a current PeopleForBikes Corporate Member to gain access to the Member Center.");
        }
        }).then(customerID =>{
