    ...
    return sfConnection
      ...
      .then(function (res) {
        try {
          ...
          throw new Error(
            '<p>Your email is currently not registered. Please register here: <a href="https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center">https://www.peopleforbikes.org/take-action/register-for-peopleforbikes-member-center</a>. Your employer must be a current PeopleForBikes Corporate Member to gain access to the Member Center.</p>',
          );
        }
      })
      .then((customerID) => {
        ...
        return sfConnection
          ...
          .then(function (res) {
            if (res.records.length > 0) {
              ...
              throw new Error(
                '<p>Your email is not affiliated with an organization in our database. Please contact Scarlet Stinchcomb at <a href="mailto:scarlet@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Email%20Affiliation%20Error">scarlet@peopleforbikes.org</a></p>',
              );
            }
          })
          .then((affiliationIDs) => {
            ...
            return sfConnection
              ...
              .then(function (res) {
                ...
                if (authedOrg) {
                  ...
                  throw new Error(
                    '<p>Your organization\'s membership has expired, please contact Scarlet Stinchcomb at <a href="mailto:scarlet@peopleforbikes.org?subject=PeopleForBikes%20Member%20Center%20-%20Organization%20Expiration">scarlet@peopleforbikes.org</a></p>',
                  );
                }
              });
          });
