...
const Title = styled.h2`
  ...
  font-family: ${(props) => props.smallMode === true ? props.theme.montserrat : props.theme.dharma }; 
  ...
  @media screen and (min-width: 320px) {
    font-size: ${(props) => props.smallMode === true ? '20px' : 'calc(40px + 15 * ((100vw - 320px) / 880))' };
    line-height: ${(props) => props.smallMode === true ? '20px' : 'calc(40px + 15 * ((100vw - 320px) / 880))' };;
  }
