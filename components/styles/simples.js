...
export const SecondaryHeading = styled.h2`
  ...
  letter-spacing: 1px;
  line-height: ${(props) => (props.fontSize ? props.fontSize * 0.88 + 'px' : '60px')};
  margin: ${(props) => (props.margin ? props.margin : '10px')};
  text-transform: ${(props) => (props.textTransform ? props.textTransform : 'none')};

  @media screen and (min-width: 320px) {
    font-size: calc(
      ${(props) => (props.fontSize ? props.fontSize * 0.88 + 'px' : '68px')} + 20 *
        ((100vw - 320px) / 880)
    );
    line-height: calc(
      ${(props) => (props.fontSize ? props.fontSize + 'px' : '60px')} + 20 * ((100vw - 320px) / 880)
    );
  }
  @media screen and (min-width: 1200px) {
  ...
  span {
    ...
    @media screen and (min-width: 320px) {
      ...
      line-height: calc(
        ${(props) => (props.fontSize ? props.fontSize + 'px' : '60px')} + 20 *
          ((100vw - 320px) / 880)
      );
    }
    @media screen and (min-width: 1200px) {
