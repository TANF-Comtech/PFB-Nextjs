 ...
 * <DoubleTheDonation>
 * 
 * Static iFrame of the DoubleTheDonation service
 * This was only designed to use on /pages/double-your-donation.js
 */
export default function DoubleTheDonation() {

  // API Key for the DoubleTheDonation Script
  let DDCONF = { API_KEY: "R1fTLU2ixqyOvcdB" }
  ...
  return (
    <>
      ...
      >
        ...
        <hr />
        <p>Did you know that <strong>thousands of companies match donations by employees</strong> to PeopleForBikes? Please use the search tool below to see if your company will match your donation and the <strong>follow the provided links if they do</strong>.</p>
      </MainContent>
      <MainContent
      ...
      <MainContent
        ...
        maxWidth="1200px"
      >
        <p style={{ textAlign: "center" }}>Questions about this page? Reach out to <a href="mailto:info@peopleforbikes.org?subject=Questions%20about%20PeopleForBikes%20DoubleTheDonation%20Service">our team</a> for more details.</p>
      </MainContent>
    </>
  )
}
